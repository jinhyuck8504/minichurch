                  ...
                  <div key={sermon.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        {sermon.youtube_url && (
                          <p className="text-red-600 text-sm">유튜브: 있음</p>
                        )}
                      </div>
                      <div className="flex space-x-2">
                        <button 
    ...
    <div className="min-h-screen bg-blue-50">
      ...
      <section className="py-16 text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 mb-8">새소망교회에 오신 것을 환영합니다</p>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">📖 최근 설교 말씀</h2>
          ...
          {publicSermons.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {publicSermons.map((sermon) => (
                <div key={sermon.id} className="bg-white border border-gray-200 rounded-lg p-6 shadow hover:shadow-lg">
                  <h3 className="text-xl font-bold mb-2">{sermon.title}</h3>
                  <p className="text-gray-600 mb-4">{sermon.preacher} · {sermon.sermon_date}</p>
                  {sermon.summary && (
